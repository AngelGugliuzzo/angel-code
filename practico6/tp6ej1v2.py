...
class Roedores(ABC):
    def __init__(self):
        self.roedorRaton = "raton"
        self.roedorGerbo="gerbo"
        self.roedorHamster="hamster"

    @abstractmethod
    def comer(self):
        print("comiendo como los ", self.roedorHamster) #-------->todos comomen como hamster
